    ...
    <div id="customer-update-section">
        <div class="contact-form-container">
            <div class="contact-form">
                <h3>EDITING DETAILS OF LOAN ID  <?php echo $loan_id; ?> OF <?php echo $current_id; ?></h3><br>
                <form action="bank_customer_loan_editer.php?loan_id=<?php echo $loan_id; ?>" method="POST">
