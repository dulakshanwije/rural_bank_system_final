...
$sql = "SELECT * FROM savings_table WHERE bank_id = '$current_bank_id'";
...
<body>
        ...
        <div class="topnavbar">
            ...
            <div class="nav-col-75">
                <div class="nav-menu">
                    ...
                    <a href="bank_view_customer_mortgages.php" class="menu-item-txt" id="topnav-about">MORTGAGES</a>
    ...
    <div class="nav-responsive-part">
        ...
        <div class="dropdown-menu" id="dropdown-menu">
            ...
            <a href="bank_view_customer_mortgages.php">MORTGAGES</a>
            <a href="bank_view_customer_details.php">CUSTOMERS</a>
        </div>
    ...
    <div id="table_design" class="table-container">
        ...
        echo "<thead>";
        echo "<tr>";
        echo "<th> Savings ID </th>";
        echo "<th> Savnigs Amount </th>";
            ...
            foreach ($res as $key => $value) {
                ...
                switch ($key) {
                    case "customer_nic":
                        ...
                        break;
                    case "savings_id":
                        $table_heading = "Savings ID";
                        break;
                    case "savings_amount":
                        $table_heading = "Savings Amount";
                        break;
                    case "savings_interest_rate":
                        $table_heading = "Interest Rate (%)";
                        break;
                    case "savings_interest_amount":
                        $table_heading = "Interest Amount";
                        break;
                    case "savings_full_amount":
