        ...
        <div class="contact-form">
            ...
            <form action="bank_customer_savings_adder.php?customer_nic=<?php echo $customer_id;?>" method="POST">
                <div class="contact-form-inputs">
                    ...
                    <input id = "mortgage_item_value" name= "mortgage_item_value" type="number" step="0.01" class="contact-txt"
                    required >
                    

                    <label for="mortgage_amount" class="bank-form-lable-txt">Mortgage Amount :</label>
                    <input id = "mortgage_amount" name= "mortgage_amount" type="number" step="0.01" class="contact-txt"
                    required >

                    <label for="mortgage_interest" class="bank-form-lable-txt">Mortgage Interest Rate (%) :</label>
                    <input id = "mortgage_interest" name="mortgage_interest" type="number" step="0.01" class="contact-txt"
                    required>

                    <label for="mortgage_interest_amount" class="bank-form-lable-txt">Mortgage Interest Amount :</label>
                    <input id = "mortgage_interest_amount" name="mortgage_interest_amount" type="number" step="0.01" class="contact-txt"
                    required>

                    <label for="mortgage_full_amount" class="bank-form-lable-txt">Mortgage Full Amount :</label>
                    <input id="mortgage_full_amount" name="mortgage_full_amount" type="number" step="0.01" class="contact-txt" 
                    required>
                    ...
                    <input id = "monthly_mortgage_payment_amount" name="monthly_mortgage_payment_amount" type="number" step="0.01" class="contact-txt"
                    required>
                    
                    <label for="mortgage_issued_date" class="bank-form-lable-txt">Mortgage Issued Date :</label>
                    <input type="text" name="mortgage_issued_date" id = "mortgage_issued_date" class="contact-txt" onfocus="(this.type = 'date')"
                    required>
                    ...
                    <input type="number" class="contact-txt" id="single_installment_days" name = "single_installment_days" required>
