            ...
            <div class="contact-form">
                ...
                <form action="customer_data_updater.php?crnt_customer_nic=<?php echo $current_id; ?>" method="POST">
                    <div class="contact-form-inputs">
                        ...
                        <?php } ?>
                        <input type="text" name="ch_fname" id="c_fname" placeholder="First Name" class="contact-txt" value="<?php echo $chfname; ?>" required>
                        <input type="text" name="ch_lname" id="c_lname" placeholder="Last Name" class="contact-txt" value="<?php echo $chlname; ?>" required>
                        ...
                        <div class="contact-txt" id="contact-selector">
                            ...
                            <div id="col-75">
                                <span>
                                    <input value="Male" type="radio" name="ch_gender" id="gender_male" <?php echo $mselected; ?> required>
                                    <label for="gender_male">Male</label>
                                </span>
                                <span>
                                    <input value="Female" type="radio" name="ch_gender" id="gender_female" <?php echo $fselected; ?> required>
                        ...
                        <input type="text" name="ch_email" id="c_email" placeholder="Email" class="contact-txt" value="<?php echo $chemail; ?>" required>
                        <input type="text" name="ch_address" id="c_address" placeholder="Address" class="contact-txt" value="<?php echo $chaddress; ?>" required>
                        <input type="text" name="ch_phone" id="c_phone" placeholder="Phone" class="contact-txt" value="<?php echo $chphone; ?>" required>
