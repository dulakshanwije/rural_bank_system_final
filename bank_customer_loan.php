            ...
            <div class="contact-form">
                ...
                <form action="bank_customer_loan_adder.php?customer_nic=<?php echo $customer_id; ?>" method="POST" onchange="autoCalculation()">
                    <div class="contact-form-inputs">
                        ...
                        <input id="loan_amount" name="loan_amount" type="number" step="0.01" class="contact-txt" onchange="autoCalculation()" required>

                        <label for="loan_interest" class="bank-form-lable-txt">Loan Interest Rate (%) :</label>
                        <input id="loan_interest" name="loan_interest" type="number" step="0.01" class="contact-txt" onchange="autoCalculation()" required>

                        <label for="loan_interest_amount" class="bank-form-lable-txt">Loan Interest Amount :</label>
                        <input id="loan_interest_amount" name="loan_interest_amount" type="number" step="0.01" class="contact-txt" onchange="autoCalculation()" required>

                        <label for="loan_full_amount" class="bank-form-lable-txt">Loan Full Amount :</label>
                        <input id="loan_full_amount" name="loan_full_amount" type="number" step="0.01" class="contact-txt" onchange="autoCalculation()" required>
                        ...
                        <input id="monthly_payment_amount" name="monthly_payment_amount" type="number" step="0.01" class="contact-txt" onchange="autoCalculation()" required>

                        <label for="loan_issued_date" class="bank-form-lable-txt">Loan Issued Date :</label>
                        <input type="text" name="loan_issued_date" id="loan_issued_date" class="contact-txt" onfocus="(this.type = 'date')" required>
